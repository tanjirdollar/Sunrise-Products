    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-3">
        ...
        <div className="relative flex-1 max-w-lg">
          ...
          <input
            type="text"
            placeholder="চালান নং (Invoice No), মালের নাম বা কারিগর দিয়ে খুঁজুন..."
            value={searchTerm}
        ...
        {filteredLots.length === 0 ? (
          <div className="bg-white rounded-xl border border-slate-200 p-12 text-center">
            ...
            <h3 className="text-base font-semibold text-slate-800">
              {searchTerm || categoryFilter !== 'all' ? 'ফিল্টারে কোনো চালান পাওয়া যায়নি' : 'এখনো কোনো চালান তৈরি করা হয়নি'}
            </h3>
            <p className="text-xs text-slate-500 mt-1 max-w-sm mx-auto">
              {searchTerm || categoryFilter !== 'all' 
                ? `"${searchTerm || categoryFilter}" এর সাথে মিল রেখে কোনো চালান পাওয়া যায়নি। ফিল্টার রিসেট করতে পারেন।`
                : 'নতুন লট আসলে চালান তৈরি করতে উপরের "নতুন চালান তৈরি" বাটনে ক্লিক করুন।'}
            </p>
            {(searchTerm || categoryFilter !== 'all') && (
              <button
                onClick={() => {
